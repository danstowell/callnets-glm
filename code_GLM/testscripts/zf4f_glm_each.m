...
%
%struct('runname', 'gill/gill_rawfile_1indall', 'indexmapper', 1:8, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_2indall', 'indexmapper', 1:8, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_3indall', 'indexmapper', 1:8, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_4indall', 'indexmapper', 1:8, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_5indall', 'indexmapper', 1:8, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_6indall', 'indexmapper', 1:8, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_7indall', 'indexmapper', 1:8, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%
%struct('runname', 'gill/gill_rawfile_1typeall', 'indexmapper', 1:40, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_2typeall', 'indexmapper', 1:40, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_3typeall', 'indexmapper', 1:40, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_4typeall', 'indexmapper', 1:40, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_5typeall', 'indexmapper', 1:40, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_6typeall', 'indexmapper', 1:40, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
%struct('runname', 'gill/gill_rawfile_7typeall', 'indexmapper', 1:40, 'startsecs', 0, 'endsecs', 14400, 'resimuldur', 0, 'datapath', sprintf('%s/zcompiled_session', zf4fdir)), ...
};
